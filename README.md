...
This service provide status metrics of all pods.

## Links

Dev:
https://dev.quant.benjamin-borbe.de/admin/k8s-pod-status/setloglevel/3
https://dev.quant.benjamin-borbe.de/admin/k8s-pod-status/status
https://dev.quant.benjamin-borbe.de/admin/k8s-pod-status/failed
